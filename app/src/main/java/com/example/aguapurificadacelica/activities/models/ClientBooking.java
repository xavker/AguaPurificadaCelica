...
public class ClientBooking {
    ...
    public ClientBooking(String idClient, String idDriver, String destination, String origin, String time, String km, String status, double originLat, double originLng, double destinationLat, double destinationLng,int numero_botellones) {
        this.idClient = idClient;
        this.idDriver = idDriver;
        this.destination = destination;
        this.origin = origin;
        ...
        this.destinationLat = destinationLat;
        this.destinationLng = destinationLng;
        this.numero_botellones=numero_botellones;
    }
    ...
    public int getNumero_botellones() {
        return numero_botellones;
    }

    public void setNumero_botellones(int numero_botellones) {
        this.numero_botellones = numero_botellones;
    }
    ...
    public void setIdHistoryBooking(String idHistoryBookingt) {this.idHistoryBooking = idHistoryBookingt;
    }
